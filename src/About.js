            ...
            <View style={styles.about}>
             ...
             <View style={styles.about}>   
                <View style={styles.abBox}>
                    <Text style={styles.abText}>Thanks for downloading my app, this app is intended for testing geography knowledge, and it is great for killing time i hope you will enjoy it</Text>
                    ...
                    <Text style={styles.abLink}  onPress={()=>Linking.openURL("https://bojanv4.herokuapp.com")}> Website!!</Text>
                    <Text  style={styles.abText}>Version 1.4.0</Text>
                </View>
             </View>
            </View>
        )
